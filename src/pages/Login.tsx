  ...
  return (
    <AuthShell title="账号登录">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="block h-10 w-full rounded-xl border border-slate-200/80 bg-white pl-10 pr-4 text-sm text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-cyan-500/30 focus:border-cyan-500 shadow-sm transition-shadow"
                  placeholder="请输入用户名"
                  value={username}
          ...
          <div className="mt-4 border-t border-slate-100 pt-4 text-center text-xs text-slate-500">
            还没有账号？{' '}
            <Link to="/auth/register" className="font-semibold text-cyan-600 hover:text-cyan-700">
              注册新账号
            </Link>
          </div>
    </AuthShell>
