...
export function PortalManagement() {
  ...
  const initialTab = (rawTab && rawTab !== 'personal') ? rawTab : 'institution';
    ...
    <div className="min-h-screen bg-slate-100 flex flex-col font-sans">
      ...
      <div className="bg-gradient-to-r from-blue-950 via-slate-900 to-sky-900 text-white h-14 px-6 flex items-center justify-between shadow-md border-b border-blue-800/40 shrink-0">
        ...
        <div className="flex items-center gap-4 text-xs">
          ...
          <div
            onClick={() => navigate('/')}
            className="flex items-center gap-2 bg-slate-800/80 hover:bg-slate-800 text-slate-200 px-3 py-1.5 rounded-xl border border-blue-500/30 transition-all cursor-pointer group"
            title="点击返回数据空间首页"
          >
            <User className="w-3.5 h-3.5 text-blue-400 group-hover:scale-110 transition-transform" />
            <span className="font-bold text-white group-hover:underline">数据空间首页</span>
            <span className="text-slate-600">|</span>
            <span className="font-medium text-blue-300">{personalForm.username}</span>
      ...
      <div className="flex-1 flex overflow-hidden">
        {/* Left Sidebar */}
        <div className="w-56 bg-white border-r border-slate-200 flex flex-col shrink-0 shadow-xs select-none">
