...
import beifangLogo from '../logo/北方管道.jpg';
import yindanLogo from '../logo/河北银丹.jpg';
import huaweiLogo from '../logo/华为.png';
import huaxinLogo from '../logo/华信泳道.jpg';
import busLogo from '../logo/廊坊公交集团.jpg';
import qixiangLogo from '../logo/廊坊气象局.png';
import yibaiLogo from '../logo/廊坊壹佰.jpg';
...
const ECO_IMAGE_FALLBACK = publicAssetUrl('assets/banner/生态合作.png');
...
export function EcoCooperation() {
  ...
  return (
    <div className="bg-slate-50 min-h-screen text-slate-800 pb-20">
      ...
      {/* 3. 合作伙伴类型 */}
      <section id="partner-types" className="py-16 container mx-auto px-4 max-w-6xl space-y-8">
        <SectionTitle
          title="合作伙伴类型"
        ...
        <div className="container mx-auto px-4 max-w-6xl space-y-10 text-center">
          ...
          <div className="space-y-4 max-w-5xl mx-auto">
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4">
              {[
                { name: '华为技术有限公司', logo: huaweiLogo },
                { name: '中国联通', logo: liantongLogo },
                { name: '新奥燃气', logo: xinaoLogo },
                { name: '国家管网集团北方管道', logo: beifangLogo },
                { name: '廊坊市气象局', logo: qixiangLogo },
              ].map((item, idx) => (
                <div
                  key={idx}
                  title={item.name}
                  className="bg-white border border-[#DDE3EC] rounded-xl sm:rounded-2xl px-6 py-3.5 h-[64px] min-w-[160px] sm:min-w-[185px] flex items-center justify-center shadow-[0_2px_8px_rgba(0,0,0,0.03)] hover:shadow-md hover:border-[#1459EB]/40 hover:-translate-y-0.5 transition-all duration-200 cursor-default group"
                >
                  <img
                    src={item.logo}
                    alt={item.name}
                    className="max-h-[34px] sm:max-h-[38px] max-w-[130px] sm:max-w-[150px] object-contain transition-transform group-hover:scale-105 duration-200"
                  />
                </div>
              ))}
            </div>
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4">
              {[
                ...
                { name: '廊坊壹佰文化', logo: yibaiLogo },
                { name: '河北银丹', logo: yindanLogo },
                { name: '华信泳道', logo: huaxinLogo },
              ].map((item, idx) => (
                <div
                  key={idx}
                  title={item.name}
              ...
              <div className="lg:col-span-6 space-y-8 pl-2">
                ...
                <div className="pt-2 pl-3">
                  ...
                  >
                    ...
                    <span className="relative z-10">立即自主注册</span>
                    <ArrowRight className="w-5 h-5 relative z-10 group-hover:translate-x-1.5 transition-transform duration-200" />
                  </a>
                </div>
              </div>
              ...
              <div className="lg:col-span-6">
                <div className="relative rounded-2xl overflow-hidden shadow-lg border border-slate-200 group bg-slate-900 min-h-[360px] flex items-center justify-center">
                  <img
                    ...
                    alt="数据生态团队合作"
                    loading="lazy"
                    onError={(event) => applyImageFallback(event.currentTarget, ECO_IMAGE_FALLBACK)}
