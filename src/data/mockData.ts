import { LucideIcon, Database, HardDrive, Package, Activity, Share2, ShieldCheck, Heart, UserCheck, FileText } from 'lucide-react';
...
export const platformStats: Stat[] = [
  { id: '1', label: '接入政府部门', value: '32', suffix: ' 家', icon: Database, category: '建设' },
  { id: '2', label: '累计数据量', value: '18.5', suffix: ' TB', icon: HardDrive, category: '业务' },
  { id: '3', label: '数据产品数', value: '24', suffix: ' 个', icon: Package, category: '专题' },
  { id: '4', label: '累计交换量', value: '1.25', suffix: ' 亿次', icon: Share2, category: '协同' },
];
...
export const keyScenarios: Scenario[] = [
  {
    ...
    description: '基于可信数据完成公积金跨地域交叉碰撞，省去线下开具证明环节，实现职工异地申贷零手续。',
  ...
  },
  {
    ...
    description: '银行可在可信方案中秒级判别抵押房产状态，实时抓取查封指令变更，使房屋线上抵押联审成为可能，防止交易风险。',
