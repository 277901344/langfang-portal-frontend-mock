          ...
          {[
            {
              role: '数据供给方',
              badge: '数据源侧',
              color: 'border-blue-200 bg-gradient-to-b from-blue-50/50 to-white text-blue-700',
              tagBg: 'bg-blue-100 text-blue-800',
              icon: Database,
              desc: '汇聚政务部门、公共事业单位、央国企及行业领军企业高价值原始数据要素。',
              duties: [
                '数据目录登记与合规挂牌',
                '部署源端可信数据连接器',
                '定义使用控制策略(Usage Policy)',
                '数据要素收益安全结算',
              ],
            },
            {
              role: '数据需求方',
              badge: '场景应用侧',
              color: 'border-emerald-200 bg-gradient-to-b from-emerald-50/50 to-white text-emerald-700',
              tagBg: 'bg-emerald-100 text-emerald-800',
              icon: Building2,
              desc: '围绕数字金融、智慧交通、临空商贸等场景释放数据要素乘数效应的实体主体。',
              duties: [
                '发布跨领域高价值场景需求',
                '申请密态数据调用与联合建模',
                '合规使用履约与结果存证',
            ...
            },
            {
              role: '技术支撑方',
              badge: '基础设施侧',
              color: 'border-purple-200 bg-gradient-to-b from-purple-50/50 to-white text-purple-700',
              tagBg: 'bg-purple-100 text-purple-800',
              icon: Cpu,
              desc: '提供隐私计算、硬件飞地(TEE)、安全沙箱与跨域调度等可信底座支撑技术。',
              duties: [
                '可信连接器研发与工程适配',
                '提供高性能TEE与密态算力环境',
                '跨网格多方协同计算安全隔离',
            ...
            },
            {
              role: '运营与治理方',
              badge: '生态服务侧',
              color: 'border-amber-200 bg-gradient-to-b from-amber-50/50 to-white text-amber-700',
              tagBg: 'bg-amber-100 text-amber-800',
              icon: ShieldCheck,
              desc: '负责空间日常运营、生态准入、法律合规审核、资产评估与收益清结算体系。',
              duties: [
                '主体身份认证与准入合规审计',
                '制定可信数据空间治理与交换规则',
                '撮合供需对接与交易流转监管',
            ...
            return (
              <div
                key={idx}
                className={cn(
                  'rounded-2xl p-6 border shadow-xs hover:shadow-md transition-all flex flex-col justify-between space-y-5',
                  item.color
                )}
              >
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <span className={cn('text-xs font-semibold px-2.5 py-1 rounded-full', item.tagBg)}>
                      {item.badge}
                    </span>
                  </div>
