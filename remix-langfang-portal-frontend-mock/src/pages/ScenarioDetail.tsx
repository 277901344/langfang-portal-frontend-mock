...
export function ScenarioDetail() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-20">
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-slate-50 via-white to-sky-50/30 border-b border-slate-200 pt-14 pb-16 sm:pt-16 sm:pb-20">
        <div className="relative w-full max-w-[1680px] mx-auto px-4 sm:px-6 lg:px-10">
          <div className="mb-6 flex items-center gap-2 text-sm text-slate-500">
            ...
            <Link to="/scenarios" className="hover:text-slate-900 transition-colors">重点场景</Link>
            <ChevronRight className="h-4 w-4 text-slate-400" />
            <span className="line-clamp-1 text-slate-900 font-medium">{scenario.name}</span>
          </div>
      ...
      <section className="w-full max-w-[1680px] mx-auto px-4 sm:px-6 lg:px-10 mt-8 sm:mt-10 grid grid-cols-1 lg:grid-cols-3 gap-6">
