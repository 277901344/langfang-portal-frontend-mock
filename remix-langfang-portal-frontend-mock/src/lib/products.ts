...
export type ProductPricingType = '免费' | '按次计费' | '包月';
export type ProductValidityType = '永久' | '自定义';

export type ProductPricingInfo = {
  type: ProductPricingType;
  unitPrice?: number; // 单次原价，如 0.10
  discountPercent?: number; // 折扣百分比，如 50 (代表50%即5折), 80 (8折), 100 (无折扣)
  discountUnitPrice?: number; // 折后单价，如 0.05
  monthlyPrice?: number; // 包月原价，如 200.00
  discountMonthlyPrice?: number; // 折后月费，如 160.00
};

export type ProductValidityInfo = {
  type: ProductValidityType;
  expireTime?: string; // 如 '2026-08-19 00:00:00'
};
...
export type PortalProductListItem = {
  ...
  validityInfo?: ProductValidityInfo;
};
...
const MOCK_PRODUCTS: PortalProductDetail[] = [
  {
    ...
    portalCustomDescription: '<p>本产品作为“公积金专题”核心要素，支持跨区域秒级数据碰撞与协同核算。</p>',
  ...
  },
  {
    ...
    portalCustomDescription: '<p>数据已脱敏聚合，用于“卫健医疗”中的态势感知与决策分析。</p>',
  ...
  },
  {
    ...
    pricingInfo: {
      type: '包月',
      monthlyPrice: 200.00,
      discountPercent: 80.00,
      discountMonthlyPrice: 160.00,
    },
    validityInfo: {
      type: '永久',
    },
  },
  {
    ...
    industryCategoryName: '公共管理、社会保障和社会组织',
    businessCategory: '法人信用专题',
    scenarioId: 'sc-003',
    scenarioName: '法人信息跨域多维联控',
    deliveryType: 'API_SERVICE',
    deliveryTypeName: 'API服务',
    deliveryMethod: '03',
    ...
    pricingInfo: {
      type: '按次计费',
      unitPrice: 0.20,
      discountPercent: 75.00,
      discountUnitPrice: 0.15,
    },
    validityInfo: {
      type: '永久',
    },
  },
  {
    ...
    pricingInfo: {
      type: '包月',
      monthlyPrice: 500.00,
      discountPercent: 70.00,
      discountMonthlyPrice: 350.00,
    },
    validityInfo: {
      type: '自定义',
      expireTime: '2026-08-19 00:00:00',
    },
  },
  {
    productId: 'LF-DP-004',
    ...
    industryCategoryName: '房地产业',
    businessCategory: '不动产生态专题',
    scenarioId: 'sc-004',
    scenarioName: '不动产确权金融联办',
    deliveryType: 'API_SERVICE',
    deliveryTypeName: 'API服务',
    deliveryMethod: '03',
